...
// Função para adicionar uma pessoa à fila
   ...
   int sr=0;
void enqueue(Fila *q, const char *nome, int idade, char cpf, char dt,char mot) {
...
// Funcao para  contar o motivo de estar na fila
// Função para adicionar uma pessoa à fila
...
int main() {
    ...
    Fila fila;
    iniciarFila(&fila);
   // R para ewclamacao, E para elogiar.

    enqueue(&fila, "Maria", 30,'g','k','R');
